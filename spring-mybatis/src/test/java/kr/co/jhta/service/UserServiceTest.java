 ...
 * @Transactional
 * 		- 단위테스트 클래스에 @Transactional 어노테이션을 부착하면 테스트 작업 과정에서 수행한 INSERT/UPDATE/DELETE 작업을 Database에 반영시키지 않고, 
 * 		    각 개별 테스트 메소드의 실행이 종료되는 즉시 롤백시킨다.
...
public class UserServiceTest {
	...
	public void testAddNewUser() {
		User user = new User("kimkim", "김김이", "zxcv1234", "kkim@gmail.com");
	...
	public void testLogin() {
		User user = userService.login("honghong", "zxcv1234");
	...
	public void testLoginFail() {
		userService.login("honghong", "zxcv123");
	}
}
